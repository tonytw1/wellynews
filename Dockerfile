...
CMD ["java", "-XshowSettings:vm", "-XX:+PrintCommandLineFlags", "-jar","/opt/wellynews/wellynews-0.0.1-SNAPSHOT.jar", "--spring.config.location=/opt/wellynews/conf/wellynews.properties"]
