...
@Component class HibernateResourceDAO @Autowired() (sessionFactory: SessionFactory) {
  ...
  @SuppressWarnings(Array("unchecked")) def getNotCheckedSince(launchedDate: Date, lastScanned: Date, maxItems: Int): List[Resource] = {
  ...
  @SuppressWarnings(Array("unchecked")) def getCommentFeedsToCheck(maxItems: Int): List[CommentFeed] = {
  ...
  @SuppressWarnings(Array("unchecked")) def getTaggedResources(tag: Tag, max_newsitems: Int): List[Resource] = {
  ...
  def getTagsMatchingKeywords(keywords: String): List[Tag] = {
    throw (new UnsupportedOperationException)
  }

  @SuppressWarnings(Array("unchecked")) def getResourcesWithTag(tag: Tag): List[Resource] = {
