    ...
    for {
      ...
      def suitableRelatedTag(tagFacetsForTag: TagContentCount): Boolean = {
        def isTagSuitableRelatedTag(relatedTag: Tag): Boolean = {
          ...
          //  * && !(relatedTag.getName == "places") && !(relatedTag.getName == "blogs") // TODO push up
          ...
          tag != relatedTag && isNotHidden && isNotBlogsOrPlaces && isNotParentOf && isNotDescendantOf // TODO implement all
        }
