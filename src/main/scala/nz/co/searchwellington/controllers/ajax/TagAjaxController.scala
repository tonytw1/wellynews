...
@Controller class TagAjaxController @Autowired()(val viewFactory: ViewFactory, var contentRetrievalService: ContentRetrievalService) extends BaseAjaxController {
