...
@Component class ContentModelBuilderServiceFactory @Autowired()(viewFactory: ViewFactory,
                                                                ...
                                                                tagMonthModelBuilder: TagMonthModelBuilder,
                                                                profilesModelBuilder: ProfilesModelBuilder,
  ...
  def makeContentModelBuilderService(): ContentModelBuilderService = {
    val modelBuilders = Seq(indexModelBuilder,
      searchModelBuilder,
      profileModelBuilder,
      tagMonthModelBuilder, tagsModelBuilder, tagGeotaggedModelBuilder, tagModelBuilder, tagCombinerModelBuilder,
      feedsModelBuilder,
      profilesModelBuilder,
